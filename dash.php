...
<title>ONline For Exam | DASHBOARD </title>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav tit3">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?> class="tit2"><a href="dash.php?q=0">Home<span class="sr-only">(current)</span></a></li>
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?> class="tit2"><a href="dash.php?q=1">User</a></li>
		<li <?php if(@$_GET['q']==2) echo'class="active"'; ?> class="tit2"><a href="dash.php?q=2">Ranking</a></li>
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?> class="tit2"><a href="dash.php?q=3">Feedback</a></li>
